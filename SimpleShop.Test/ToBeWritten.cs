...
namespace SimpleShop.Test
{
    public class ToBeWritten{
        ...
        /// <summary>
        ///  Convert an ordered input of KeywordPairs to a valid InvoicePosition.
        ///  Rating 2
        /// </summary>
        [Test]
        ...
        /// <summary>
        ///  Now extend the code to make sure that you are also taking wrong serialization into account. For instnace, %%&$5 is not a valid number
        ///  Rating 2
        /// </summary>
        [Test]
        ...
        public void Invoice_CreateCustomer_Student(){
            var student = Customer.CreateCustomer("S'chn T'gai Spock", "Student");
            // BaseType == Parent
        ...
        {
            // Create company if defined else default to <Customer>
        ...
        /// <summary>
        ///  Include a discount of 20% before VAT for Students
        ///  Rating 2-3
        /// </summary>
        [Test]
        [Category("InvoicePosition")]
        ...
        /// <summary>
        ///  Extend InvoicePosition.CreateFromPairs so that it will take the correct customer type!
        ///  Rating 2
        /// </summary>
        [Test]
        [Category("InvoicePosition")]
        ...
        ///  This test will be ok even if you were not able to include a working discount. More information is provided in the Main function in SimpleShop.cs.
        ...
        public void FullProgram_OutputCorrect_Valid(){
            using (var sw = new StringWriter()){
                Console.SetOut(sw);
                SimpleShop.Main(new string[]{"../../../../SimpleShop.Test/SampleOrder.tag"}); // change this to path of your SampleOrder.tag file
